    ...
    while (attempt < this.config.retryAttempts) {
      try {
        ...
        const parkInsert: LiveParkInsert = {
          ...
          regular_open: parkData.hours.regular.open,
          regular_close: parkData.hours.regular.close,
        ...
        if (existingPark) {
          ...
          if (mapping) {
            const parkUpdate: LiveParkInsert = {
              ...
              regular_open: existingPark.hours.regular.open,
              regular_close: existingPark.hours.regular.close,
